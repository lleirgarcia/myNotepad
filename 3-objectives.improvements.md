...
Todo side:
- [X] User can add some texts to do, with priority and area.
- [X] User will see the list of todos by different areas and by all areas together.
- If user adds calendar date to a todo it's gonna see it in the top of the list. 
...
Future criteria:
- User can use app in Android.
- User can log in/log out (multiuser).